...
export const HOME_FEATURES = [
  {
    ...
    description: 'Monitor your GPA, attendance, and academic progress in real-time.',
    iconColor: 'text-yellow-500'
  },
  {
    icon: 'Users',
    title: 'Connect with Peers',
    description: 'View and connect with other students in your academic network.',
    iconColor: 'text-blue-500'
  },
  {
    icon: 'Calendar',
    title: 'Stay Organized',
    description: 'Keep track of assignments, schedules, and important academic dates.',
